...
const workspaceTargets = [".data", "dist", ".nuxt", ".output", "node_modules"];
const rootTargets = ["node_modules", "dist", ".nuxt", ".output"];
const lockfiles = [
  "bun.lockb",
  "bun.lock",
  "package-lock.json",
...
// run install inside docs to ensure workspace dependencies are installed
...
// Run prepare after install to ensure everything is set up correctly
const prepare = spawnSync("bun", ["run", "dev:prepare"], {
  cwd: rootDir,
  stdio: "inherit",
});
